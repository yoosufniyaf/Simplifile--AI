        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-border">
            <Link to="/dashboard" className="flex items-center gap-3">
              ...
              <div>
                <span className="font-semibold text-lg block" style={{ fontFamily: 'Outfit, sans-serif' }}>Simplifile</span>
          ...
          <div className="p-4 border-t border-border">
            <div className="flex items-center gap-3 px-2 py-2 mb-3 rounded-lg bg-muted/30">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium capitalize">{user?.plan || "Basic"} Plan</span>
              </div>
              {user?.subscription_status === "trial" && (
                <span className="text-xs bg-primary/20 text-primary px-2 py-0.5 rounded-full ml-auto">Trial</span>
              )}
            </div>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="w-full justify-start gap-3 px-2" data-testid="user-menu">
